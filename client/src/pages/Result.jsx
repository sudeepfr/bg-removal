      ...
      <div className="mx-4 my-3 lg:mx-14 min-h-[80vh]">
         <div className="bg-white rounded-lg px-8 py-6 drop-shadow-sm ">
            ...
            <div className="flex justify-center sm:justify-end items-center flex-wrap gap-4 mt-6">
               <button onClick={()=>navigate('/')} className="px-8 py-2.5 text-violet-600 rounded-full  tex-sm border hover:scale-105 transition-all duration-700">Try another image</button>
